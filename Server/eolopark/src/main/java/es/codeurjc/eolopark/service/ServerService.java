 ...
 *
 * The parkId is included in the URL used to connect to the websocket.
 */

@Component
public class ServerService extends AbstractWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        Long id = getParkIdFromURI(session);
    ...
    private static Long getParkIdFromURI(WebSocketSession session) {
        ...
        return Long.parseLong(parameters.getFirst("parkId"));
    }
